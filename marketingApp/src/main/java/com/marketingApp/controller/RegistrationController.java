...
//	}
	...
	public String saveRegistration(RegistrationDto dto , Model model) {
	    Registration existingUserByEmail = registrationService.findByEmail(dto.getEmail());
	    Registration existingUserByMobile = registrationService.findByMobile(dto.getMobile());
	    ...
	    registrationService.saveRegistration(reg);
	    emailService.sendEmail(dto.getEmail(), "Welcome", "You have successfully registered on our website");
